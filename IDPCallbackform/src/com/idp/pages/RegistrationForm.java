...
//     }
	...
	public void newregistration(String firstname,String lastname,String emailaddress,String password,String residence,String destination,String subject,String startyear, String url, String affiliate) throws InterruptedException, IOException {
	   ...
	   //         "return performance.timing.loadEventEnd - performance.timing.navigationStart;");
		...
		Commanmethod.type(passwd,password);
		//String emailgood = confirmEmailSucErrMsg.getText();
//		if (confirmEmailSucErrMsg.isDisplayed()) {
...
//			Boolean isPresen1 = Commanmethod.isEnabled(geoconsentflag);
//
//			if (isPresen1 == true) {
//				Commanmethod.scrolldown3();
//				Commanmethod.click(geoconsentflag);
//			}
