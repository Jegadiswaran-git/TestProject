...
public class ReviewCase {
	...
	public void newreview(String url,String reviewtitle, String reviewcomments, String yearofgrad, String studylevel, String subject, String coursename, String firstname, String lastname, String emailaddress, String yourcountry, String password, String country, String univname, String startdate, String enddate, String affiliate) throws InterruptedException, IOException, SQLException, InvocationTargetException {

		ReviewCase newreview = new ReviewCase();
		
		Commanmethod.openBrowser(url);
		newreview.newrevtwo(url,reviewtitle,reviewcomments,yearofgrad,studylevel,subject,coursename,firstname,lastname,emailaddress,yourcountry,password,country,univname,startdate,enddate,affiliate);
		
	}
	
	public static void newrevtwo(String url,String reviewtitle, String reviewcomments, String yearofgrad, String studylevel, String subject, String coursename, String firstname, String lastname, String emailaddress, String yourcountry, String password, String country, String univname, String startdate, String enddate, String affiliate) throws InterruptedException, IOException, SQLException {
		ReviewPage revobj = PageFactory.initElements(Commanmethod.driver, ReviewPage.class);
		
		revobj.submitreview(url,reviewtitle,reviewcomments,yearofgrad,studylevel,subject,coursename,firstname,lastname,emailaddress,yourcountry,password,country,univname,startdate,enddate,affiliate);
