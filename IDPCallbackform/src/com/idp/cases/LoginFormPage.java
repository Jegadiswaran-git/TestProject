...
public class LoginFormPage {
	...
	public static void newlogin(String email, String password, String url) throws InterruptedException, IOException, SQLException {
		
		LoginFormPage newlogin = new LoginFormPage();
		Commanmethod.openBrowser(url);
		newlogin.newlogtwo(email, password, url);
		
	}
	
	public static void newlogtwo(String email, String password, String url) throws InterruptedException, IOException, SQLException {
		LoginForm regf = PageFactory.initElements(Commanmethod.driver, LoginForm.class);
		
		regf.newlogin(email, password, url);
