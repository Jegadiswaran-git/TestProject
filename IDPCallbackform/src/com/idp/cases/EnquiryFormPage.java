...
public class EnquiryFormPage {
	...
	public static void newregtwo(String univname,String fname,String lname,String email,String date,String month,String year,String phonenumber,String phonetype,String countrycode,String studylevel,String subject,String startyear,String password,String univname2,String subject2,String url,String studylevel2, String destination, String qualification, String affiliate, String startyear1, String startmonth, String startmonth2) throws InterruptedException, IOException, SQLException {
		...
		enqobj.newenquiryform(univname, fname, lname, email, date, month, year, phonenumber, phonetype, countrycode, studylevel, subject, startyear, password, univname2, subject2, url, studylevel2, destination, qualification, affiliate, startyear1,  startmonth, startmonth2);
