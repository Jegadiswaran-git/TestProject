...
public class NewRegistration {
	...
	public static void newregister(String firstname,String lastname,String emailaddress,String password,String residence,String destination,String subject,String startyear, String url, String affiliate) throws InterruptedException, IOException, SQLException {

		NewRegistration newreg = new NewRegistration();
		
		Commanmethod.openBrowser(url);
		newreg.newregtwo(firstname, lastname, emailaddress, password, residence, destination, subject, startyear, url, affiliate);
		
		

	}
	
	public static void newregtwo(String firstname,String lastname,String emailaddress,String password,String residence,String destination,String subject,String startyear, String url, String affiliate) throws InterruptedException, IOException, SQLException {
		RegistrationForm regf = PageFactory.initElements(Commanmethod.driver, RegistrationForm.class);
		
		regf.newregistration(firstname, lastname,emailaddress, password, residence, destination, subject, startyear, url, affiliate);
